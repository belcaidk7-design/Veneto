...
const productContent: Record<string, ProductContentEntry> = {
  ...
  bollards: {
    ...
    story: [
      'We have produced urban bollards for many years, from classical truncated cones to contemporary designs. All are carved from a single block, no hollow or assembly, for maximum impact resistance.',
  ...
  curbs: {
    ...
    story: [
      'We have supplied curbs for many years, for private projects and Italian public tenders. The most-requested sections (10×25, 15×30) are stocked; others produced in 4–6 weeks.',
  ...
  externalCladding: {
    ...
    story: [
      'We have supported façade projects for many years, from glued-on-render cladding to ventilated rear-anchored systems. On contemporary architectural projects, ventilated installation prevails: better insulation, fast drying, and the ability to replace one panel without dismounting everything.',
  ...
  openBookSlabs: {
    ...
    story: [
      'We have supplied open-book pairs to fabricators, joiners and architects for many years. Our work: pre-selecting pairs at the quarry, validating veining coherence, then shipping protected by custom wood crates.',
