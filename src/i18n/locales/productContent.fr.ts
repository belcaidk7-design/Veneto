...
const productContent: Record<string, ProductContentEntry> = {
  externalPaving: {
    ...
    provenance: 'Carrières partenaires de Trento (porphyre), Olbia (granit) et Sant\u2019Ambrogio di Valpolicella (grès).',
    signature: 'Calepinage personnalisé livré avec chaque commande, plus une réserve de coupe pré-calculée.',
    bestProjects: [
      'Restauration de la place historique d\u2019un village lombard (820 m² en pavé porphyre, 2023)',
      'Plage de piscine et abords d\u2019une villa toscane (340 m² en granit flammé, 2024)',
      'Allée d\u2019accès et cour pavée d\u2019un domaine viticole en Provence (180 m² grès vieilli, 2022)',
    ],
  },
  fountains: {
    ...
    provenance: 'Bloc de Carrare et Trani, sculpture à Pietrasanta (Toscane).',
    signature: 'Plan hydraulique fourni avec chaque fontaine sur mesure (pompe, drainage, raccordement).',
    bestProjects: [
      'Fontaine centrale d\u2019un riad rénové à Marrakech (marbre Bianco Carrara, 2,4 m, 2023)',
      'Vasque ronde d\u2019entrée pour une villa Cap-Ferrat (calcaire de Trani, 2024)',
      'Fontaine murale Renaissance reproduite pour un domaine en Toscane (2022)',
    ],
  },
  columns: {
    ...
    bestProjects: [
      'Péristyle de 8 colonnes corinthiennes en calcaire pour une orangerie privée (Île-de-France, 2023)',
      'Quatre colonnes monolithes en marbre Carrara pour un hall d\u2019hôtel à Milan (2024)',
      'Colonnes dorique en granit pour un porche de villa balnéaire (Sardaigne, 2022)',
    ],
  },
  balustrades: {
    ...
    bestProjects: [
      'Balustrade de terrasse panoramique pour une villa lacustre (Côme, 80 m linéaires, 2023)',
      'Mains courantes intérieures pour un escalier d\u2019hôtel particulier (Paris, 2024)',
      'Restauration de la balustrade d\u2019une orangerie XVIIIe (Provence, 2022)',
    ],
  },
  flowerBoxes: {
    ...
    bestProjects: [
      'Série de 12 jardinières d\u2019hôtel rooftop à Milan (calcaire Trani, 2024)',
      'Jardinières monumentales d\u2019entrée de domaine viticole (Bordeaux, grès, 2023)',
      'Aménagement paysager privé Côte d\u2019Azur (24 jardinières sur mesure, 2022)',
    ],
  },
  benches: {
    ...
    bestProjects: [
      'Mobilier urbain de la rénovation d\u2019une promenade lacustre (18 bancs granit, 2023)',
      'Cinq bancs monolithes pour un parc privé en Bourgogne (calcaire, 2024)',
      'Mobilier d\u2019accueil pour un musée régional italien (granit flammé, 2022)',
    ],
  },
  bollards: {
    ...
    bestProjects: [
      'Cinquante bornes pour la sécurisation d\u2019une zone piétonne (centre-ville italien, 2023)',
      'Bornes décoratives d\u2019entrée pour un domaine en Suisse (granit, 2024)',
      'Restauration des bornes d\u2019une place historique (porphyre, 2022)',
    ],
  },
  curbs: {
    ...
    bestProjects: [
      'Bordures d\u2019allée et de parterres pour un hôtel 5 étoiles (320 m, granit flammé, 2024)',
      'Réfection complète des bordures d\u2019une place de village (porphyre, 2023)',
      'Bordures de jardin pour un domaine privé en Suisse (granit brossé, 2022)',
    ],
  },
  sculptures: {
    ...
    bestProjects: [
      'Buste portrait grandeur nature pour un collectionneur privé (marbre statuaire, 2023)',
      'Sculpture abstraite monumentale pour le jardin d\u2019une fondation (calcaire, 3 m, 2024)',
      'Reproduction d\u2019un angelot Renaissance pour une chapelle privée (marbre, 2022)',
    ],
  },
  externalCladding: {
    ...
    bestProjects: [
      'Façade d\u2019immeuble résidentiel haut de gamme (820 m², calcaire Trani agrafé, Lyon, 2024)',
      'Restauration de façade d\u2019un palais XIXe (Italie, 2023)',
      'Parement et soubassement d\u2019une villa contemporaine (porphyre + grès, Suisse, 2022)',
    ],
  },
  interiorFlooring: {
    ...
    bestProjects: [
      'Sol de réception d\u2019une villa lacustre (Calacatta poli 60×120, 240 m², 2024)',
      'Sols intégraux d\u2019un hôtel 5 étoiles (Trani adouci, 1 200 m², 2023)',
      'Sol de cuisine ouverte avec îlot (granit flammé, 90 m², 2022)',
    ],
  },
  interiorCladding: {
    ...
    bestProjects: [
      'Mur signature en Calacatta Viola pour un salon parisien (4 m × 3 m bookmatch, 2024)',
      'Tête de lit monumentale en Sahara Noir pour une suite d\u2019hôtel (2023)',
      'Habillage intégral d\u2019un escalier en calcaire Botticino (villa privée, 2022)',
    ],
  },
  kitchenCountertops: {
    ...
    bestProjects: [
      'Îlot bookmatch de 3,8 m en Calacatta Borghini pour une cuisine privée (Côme, 2024)',
      'Plans de cuisine et arrière en mitered edge 6 cm (Statuario, 2023)',
      'Cuisine professionnelle d\u2019un restaurant étoilé (granit Nero Assoluto, 2022)',
    ],
  },
  sinks: {
    ...
    bestProjects: [
      'Paire de vasques en marbre Calacatta pour une suite parentale (2024)',
      'Lavabos pleine masse d\u2019un spa hôtelier (granit gris flammé, 2023)',
      'Vasque sculptée sur dessin pour une villa contemporaine (Statuario, 2022)',
    ],
  },
  bathtubs: {
    ...
    bestProjects: [
      'Baignoire ovale 200 cm en Calacatta Viola pour une suite parentale (Côte d\u2019Azur, 2024)',
      'Baignoire monolithe sur dessin pour un penthouse milanais (Statuario, 2023)',
      'Baignoire de spa privé en marbre noir (Sahara Noir, 2022)',
    ],
  },
  openBookSlabs: {
    ...
    bestProjects: [
      'Six paires Calacatta Viola pour un projet de suites hôtelières (Dubaï, 2024)',
      'Granit Patagonia bookmatch pour une réception d\u2019entreprise (Genève, 2023)',
      'Statuario pour une marbrerie partenaire en Allemagne (2022)',
    ],
  },
  blockSlabs: {
    ...
    bestProjects: [
      'Approvisionnement régulier d\u2019une marbrerie haut de gamme suisse (depuis 2019)',
      'Container complet de Calacatta pour un projet d\u2019hôtel (Allemagne, 2024)',
      'Réservation de bloc Statuario pour un agenceur parisien (2023)',
    ],
  },
};
